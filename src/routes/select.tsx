...
export const Route = createFileRoute("/select")({
  head: () => ({
    meta: [{ title: "Choose your assessment — Elevate" }, { name: "robots", content: "noindex" }],
  }),
...
const skills: {
  ...
  },
  {
    id: "react",
    name: "React",
    blurb: "Hooks, state, component patterns",
    icon: Atom,
    tint: "#61dafb",
  },
  {
  ...
  { id: "ai", name: "AI", blurb: "Prompting, agents, LLMs", icon: Bot, tint: "#7c3aed" },
  {
    ...
    blurb: "Models, training, evaluation",
    icon: Brain,
    tint: "#0f9d58",
  },
  {
...
const types: {
...
}[] = [
  {
    id: "pure",
    name: "Pure Code",
    blurb: "Timed algorithm challenges with hidden tests.",
    icon: Braces,
  },
  {
    id: "vibe",
    name: "Vibe Code",
    blurb: "Conversational, AI-paired coding scenarios.",
    icon: MessageSquareCode,
  },
  {
    id: "experience",
    name: "Experience Code",
    blurb: "Behavioral + real-world code review.",
    icon: Lightbulb,
  },
];
      ...
      <main className="mx-auto max-w-5xl px-6 py-14">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-lg text-muted-foreground">
            Pick a language, then a test format. Ten questions. About twelve minutes.
          </p>
        </div>
        ...
        <div className="mt-14 flex items-center justify-between border-t border-border pt-8">
          <div className="text-sm text-muted-foreground">
            {skill && testType ? (
              <>
                <span className="font-semibold text-foreground capitalize">{skill}</span> ·{" "}
                <span className="font-semibold text-foreground capitalize">{testType} code</span>
              </>
            ) : (
